...
class FlatsControllerTest < ActionController::TestCase
  ...
  test "should create flat" do
    assert_difference('Flat.count') do
      post :create, flat: { address: @flat.address, day_price: @flat.day_price, description: @flat.description, owner_id: @flat.owner_id, title: @flat.title }
    end
  ...
  test "should update flat" do
    patch :update, id: @flat, flat: { address: @flat.address, day_price: @flat.day_price, description: @flat.description, owner_id: @flat.owner_id, title: @flat.title }
    assert_redirected_to flat_path(assigns(:flat))
  end
